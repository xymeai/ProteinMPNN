...
# MODIFY this path
with open("/home/justas/projects/lab_github/mpnn/data/pdbs.jsonl") as json_file:
            ...
            if chain == "A":
                fixed_position_dict[chain] = [
                    ...
                    [
                        [
                            int(item)
                            for item in list(itertools.chain(list(np.arange(50, 150))))
                        ],
                        "ACEFGHIKLMNRSTVWYX",
                    ],
                    [
                        [
                            int(item)
                            for item in list(itertools.chain(list(np.arange(160, 200))))
                        ],
                        "FGHIKLPQDMNRSTVWYX",
                    ],
                ]
